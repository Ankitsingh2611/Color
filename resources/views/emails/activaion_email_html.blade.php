            	...
            	<tr>
            		<td>
            			<div class="text" style="padding: 0 4em; text-align: center;">
            				<h2>Please click on the activation link.</h2>
            				<p>A small river named Duden flows by their place and supplies it with the necessary regelialia.</p>
            				<p><a href="{{ route('user.activateaccount',$activation_code) }}" class="btn btn-primary">Activate Account</a></p>
            			</div>
            		</td>
            	</tr>
            </table>
